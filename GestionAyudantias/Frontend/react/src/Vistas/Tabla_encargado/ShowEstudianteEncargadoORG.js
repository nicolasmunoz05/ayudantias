...
//  const handlePostData = (postulacionId, aprobadoRechazoValue) => {
//   // Determinar el semestre actual
//   const currentMonth = new Date().getMonth() + 1; // Se suma 1 ya que los meses en JavaScript van de 0 a 11
