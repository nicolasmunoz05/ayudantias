...
const CompEditEstudiante = () => {
    ...
    const getEstudianteByRut = async () => {
        try {
            ...
            setHoras_ayudantia_estudiante(res.data.horas_ayudantia_estudiante);
        } catch (error) {
    ...
    const update = async (e) => {
        ...
        if (Object.keys(newErrors).length === 0) {
            try {
                ...
                showNotification(`Estudiante  "${nombres_estudiante} ${apellido1_estudiante}" editado exitosamente`, 'info',{
                    position: 'top-right',
                    autoClose: 3000,
                ...
                <form onSubmit={update}>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-md-4 mb-3'>
                            ...
                            {errors.nombres_estudiante && (
                                <div className='invalid-feedback'>{errors.nombres_estudiante}</div>
                            )}
                        </div>
                        <div className='col-md-4 mb-3'>
                            ...
                            />
                            {errors.año_ingreso_estudiante && (
                                <div className='invalid-feedback'>{errors.año_ingreso_estudiante}</div>
                            )}
                        </div>
                    ...
                    <div className='row'>
                        <div className='col-md-4 mb-3'>
                            ...
                            />
                            {errors.apellido1_estudiante && (
                                <div className='invalid-feedback'>{errors.apellido1_estudiante}</div>
                            )}
                        </div>
                        <div className='col-md-4 mb-3'>
                            ...
                            />
                            {errors.apellido2_estudiante && (
                                <div className='invalid-feedback'>{errors.apellido2_estudiante}</div>
                            )}
                        </div>
                        <div className='col-md-4 mb-3'>
                            ...
                            />
                            {errors.ppa_estudiante && (
                                <div className='invalid-feedback'>{errors.ppa_estudiante}</div>
                            )}
                        </div>
                    </div>
                    ...
                    <div className='col-md-4 mb-3'>
                        ...
                        />
                        {errors.correo_institucional_estudiante && (
                            <div className='invalid-feedback'>{errors.correo_institucional_estudiante}</div>
                        )}
                    </div>
                    ...
                    <div className='col-md-4 mb-3'>
                        ...
                        />
                        {errors.contraseña_estudiante && (
                            <div className='invalid-feedback'>{errors.contraseña_estudiante}</div>
                        )}
                    </div>
                    <div className='col-md-4 mb-3'>
                    ...
                    <button type='submit' className='btn btn-primary mb-1 mr-1'>Guardar Cambios</button>
                    <Link to="/admin/estudiante" className='btn btn-secondary mb-1 mr-1'>Volver atrás    </Link>
                </form>
            </div>
        </div>
    )
